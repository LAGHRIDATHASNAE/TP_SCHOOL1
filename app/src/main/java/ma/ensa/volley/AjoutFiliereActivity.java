...
public class AjoutFiliereActivity extends AppCompatActivity implements  View.OnClickListener{

    private EditText code, libelle;
    private Button bnAdd;
    RequestQueue requestQueue;
    String insertUrl = "http://192.168.1.109:8088/api/v1/filieres";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ajout_filiere);
